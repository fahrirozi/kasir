            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <button class="btn btn-tool" data-toggle="modal" data-target="#add-data"><i class="fas fa-plus" class="text-right"></i>Tambah Data
</button>
                </div>
                <!-- /.card-tools -->
              </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="submit" class="btn btn-primary btn-flatnnnn">Save</button>
            </div>
            <?php echo form_close() ?>
          </div>
          <!-- /.modal-content -->
