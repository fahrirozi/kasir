...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="<?=  base_url('AdminLTE') ?> /" class="navbar-brand">
        <span class="brand-text font-weight-light text-primary"><i class="fas fa-cart text-primary"></i><b><sup>ez</sup>Cash Payment</b></span>
      </a>
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
        ...
        <li class="nav-item">
         <?php if (session()->get('level') == '1') { ?>
          ...
          <?php } else { ?>
            <a class="nav-link text-primary"  href="<?= base_url('Home/LogOut') ?>" data-toggle="modal" data-target="#logoutModal">
        ...
        <div class="row">
          ...
          <div class="col-lg-5">
            <div class="card bg-dark">
              <div class="card-header">
                <h5 class="card-title m-0"><b>Total Belanja</b></h5>
              </div>
              <div class="card-body">
               <h1 class="display-4 text-right text-succes"><b>Rp. <?=number_format ($grand_total,0)?>.-</b></h1>
              </div>
            </div>
          </div>
                ...
                <?php echo form_open('Penjualan/InsertCart')?>
                  ...
                  <div class="col-2 input-group">
                    ...
                    <a class="btn btn-primary"  data-toggle="modal" data-target="#cari-produk">
                      ...
                      <button type="reset" class="btn btn-danger btn"><i class="fas fa-times"></i></button>
                    </span>
                  </div>
                  <div class="col-3">
                  <input name="nama_produk" id="nama_produk" class="form-control" placeholder="Nama Produk" readonly>
                  </div>
                  <div class="col-1">
                  <input name="nama_kategori" id="nama_kategori" class="form-control" placeholder="Kategori" readonly>
                  </div>
                  <div class="col-1">
                  <input name="nama_satuan"  id="nama_satuan" class="form-control" placeholder="Satuan" readonly>
                  </div>
                  <div class="col-1">
                  <input name="harga_jual" id="harga_jual" class="form-control" placeholder="Harga" readonly>
                  </div>
                  <div class="col-1">
                  ...
                  <a href="<?=base_url('Penjualan/ResetCart')?>" class="btn btn-warning"><i class="fas fa-sync"></i> Clear</a>
                  <a class="btn btn-success" data-toggle="modal" data-target="#payment" onclick="Payment()"><i class="fas fa-coins"></i> Payment</a>
                  </div>
                  </div>
                  <?php echo form_close()?>
                </div>
        ...
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
              ...
              <button type="submit" class="btn btn-primary btn-flat"><i class="fas fa-save"></i>Save Transaction</button>
            </div>
            <?php echo form_close() ?>
          </div>
  <!-- Modal-content  -->
